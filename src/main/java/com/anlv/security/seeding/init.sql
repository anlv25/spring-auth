...
insert into jwt_security.public.role (id,name) values(1,'ADMIN');
insert into jwt_security.public.role (id,name) values(2,'USER');
...
insert into jwt_security.public.permission
